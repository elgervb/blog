...
/**
 * 
 * This relies on HTTP authentication, which can be enabled in the .htaccess in case of Apache
 * 
 * <code><pre>
...
class HttpAuth implements IAuthService
{
    ...
    public function authenticate()
    {
        ...
        if (isset($_SERVER['HTTP_AUTHORIZATION']) && ! isset($_SERVER['PHP_AUTH_USER']) && ! isset($_SERVER['PHP_AUTH_USER'])) {
        ...
        if (! isset($_SERVER['PHP_AUTH_USER']) || ! isset($_SERVER['PHP_AUTH_PW'])) {
            ...
            $username = $this->forceUtf8($_SERVER['PHP_AUTH_USER']);
            $password = $this->forceUtf8($_SERVER['PHP_AUTH_PW']);
